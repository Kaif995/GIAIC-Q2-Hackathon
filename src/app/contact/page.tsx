        ...
        <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
            <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                <div>
                    ...
                    <p className="text-sm text-gray-300 mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we`&apos;`, `&lsquo;`, `&#39;`, `&rsquo;`d love to hear about your project  and provide help.</p>
                ...
                <div className="bg-gray-100 p-6 rounded-lg">
                    <h2 className="text-lg mb-4 text-center font-extrabold">Contact Us</h2>
